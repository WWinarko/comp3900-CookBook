...
function Checkout({checkout, setCheckout}) {
  ...
  return (
    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={6}>
        <Typography paragraph variant="h5" gutterBottom align="right" sx={{color: "#FE793D",  fontWeight: "bold", fontSize: "1.75rem"}}>$ {subtotal + postage}.00 </Typography>
      </Grid>
    </Grid>
    ...
    <>
      ...
      <CheckoutButton sx={{width: '100%'}} onClick={() => setCheckout(false)}>Pay Now</CheckoutButton>
    </> 
    }
    </Paper>
  )
